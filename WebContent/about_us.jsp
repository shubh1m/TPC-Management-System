...
<body>
	...
	<h3>Objectives</h3>
	<ul>
	    <li>To start innovative PG programs in humanities and social sciences, basic sciences, engineering and technology. </li>
	    <li>To focus on PhD in all disciplines. </li>
	    <li>To participate in e-governance and similar projects of the state of Rajasthan. </li>
	    <li>To enhance participation in ITRA projects of MIT. </li>
	    <li>To optimize use of critical resources by multitasking. </li>
	    <li>To establish vibrant and strong alumni network. </li>
	    <li>To organize regular conferences to enhance networking and brand equity. </li>
